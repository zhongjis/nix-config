# Auto-generated using compose2nix v0.3.1.
{
  ...
  virtualisation.oci-containers.containers."dify-api" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/volumes/app/storage:/app/api/storage:rw"
    ];
    dependsOn = [
      "dify-db"
      "dify-redis"
  ...
  virtualisation.oci-containers.containers."dify-db" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/volumes/db/data:/var/lib/postgresql/data:rw"
    ];
    ports = [
      "5432:5432/tcp"
    ];
  ...
  virtualisation.oci-containers.containers."dify-nginx" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/nginx/conf.d:/etc/nginx/conf.d:rw"
      "/home/zshen/personal/dify/docker/nginx/docker-entrypoint.sh:/docker-entrypoint-mount.sh:rw"
      "/home/zshen/personal/dify/docker/nginx/https.conf.template:/etc/nginx/https.conf.template:rw"
      "/home/zshen/personal/dify/docker/nginx/nginx.conf.template:/etc/nginx/nginx.conf.template:rw"
      "/home/zshen/personal/dify/docker/nginx/proxy.conf.template:/etc/nginx/proxy.conf.template:rw"
      "/home/zshen/personal/dify/docker/nginx/ssl:/etc/ssl:rw"
      "/home/zshen/personal/dify/docker/volumes/certbot/conf:/etc/letsencrypt:rw"
      "/home/zshen/personal/dify/docker/volumes/certbot/conf/live:/etc/letsencrypt/live:rw"
      "/home/zshen/personal/dify/docker/volumes/certbot/www:/var/www/html:rw"
    ];
    ports = [
      "80:80/tcp"
      "443:443/tcp"
  ...
  virtualisation.oci-containers.containers."dify-plugin_daemon" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/volumes/plugin_daemon:/app/storage:rw"
    ];
    ports = [
      "5003:5003/tcp"
    ];
  ...
  virtualisation.oci-containers.containers."dify-redis" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/volumes/redis/data:/data:rw"
    ];
  ...
  virtualisation.oci-containers.containers."dify-sandbox" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/volumes/sandbox/dependencies:/dependencies:rw"
    ];
    log-driver = "journald";
    extraOptions = [
  ...
  virtualisation.oci-containers.containers."dify-ssrf_proxy" = {
    ...
    volumes = [
      "/home/zshen/personal/dify/docker/ssrf_proxy/docker-entrypoint.sh:/docker-entrypoint-mount.sh:rw"
      "/home/zshen/personal/dify/docker/ssrf_proxy/squid.conf.template:/etc/squid/squid.conf.template:rw"
    ];
    log-driver = "journald";
    extraOptions = [
      "--entrypoint=[\"sh\", \"-c\", \"cp /docker-entrypoint-mount.sh /docker-entrypoint.sh && sed -i 's/$//' /docker-entrypoint.sh && chmod +x /docker-entrypoint.sh && /docker-entrypoint.sh\"]"
