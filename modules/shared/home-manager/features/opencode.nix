...
in {
  ...
  programs.opencode = {
    ...
    settings = {
      ...
      provider = {
        openai = {
          api_key = "{file:${config.sops.secrets.openai_api_key.path}}";
          models = {
        ...
        anthropic = {
          api_key = "{file:${config.sops.secrets.anthropic_api_key.path}}";
          models = {
        ...
        openrouter = {
          api_key = "{file:${config.sops.secrets.openrouter_api_key.path}}";
          models = {
