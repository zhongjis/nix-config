{
  ...
  myHomeManager.services.tmux.enable = lib.mkDefault false;
  myHomeManager.services.herdr.enable = lib.mkDefault true;
  ...
  myHomeManager.jujutsu.enable = lib.mkDefault false;
