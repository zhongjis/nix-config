---
name: git-master
upstream: "https://github.com/code-yeongyu/oh-my-openagent/tree/dev/src/features/builtin-skills/git-master"
...
Use available task/todo tracking tool to register each commit as a trackable item:
