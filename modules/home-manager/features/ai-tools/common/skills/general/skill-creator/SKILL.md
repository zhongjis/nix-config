...
**Description optimization**: Skip if the environment lacks CLI tooling for automated evaluation.
...
Please add steps to your TodoList, if you have such a thing, to make sure you don't forget. Make sure to put "Create evals JSON and run `eval-viewer/generate_review.py` so human can review test cases" in your TodoList to make sure it happens.
