...
<p align="center">
  ...
  <br/>
  <sub>动画由 <a href="https://github.com/alchaincyf/design reference">design reference</a> skill 制作</sub>
</p>
...
Agent Skill 生态在快速扩张。AI Agent 工具体系正在逐步支持 SKILL.md 格式。当你有 10 个 Skills 时可以手动维护；当你有 60+ 个 Skills 时，你需要一个系统。
...
无法访问 GitHub 的朋友，可以直接下载 zip 包：[darwin-skill.zip](https://pub-161ae4b5ed0644c4a43b5c6412287e03.r2.dev/skills/darwin-skill.zip)，解压后把 SKILL.md 放到 `~/.opencode/skills/darwin-skill/` 目录即可。
...
| 📺 B站 | [Upstream author](https://space.bilibili.com/14097567) |
| ▶️ YouTube | [@Alchain](https://www.youtube.com/@Alchain) |
| 📕 小红书 | [Upstream author](https://www.xiaohongshu.com/user/profile/5abc6f17e8ac2b109179dfdf) |
| 💬 公众号 | 微信搜「Upstream author」 |
