...
Agent skill ecosystems are expanding fast. AI agent tools increasingly support the SKILL.md format. When you have 10 skills, you can maintain them by hand. When you have 60+, you need a system.
...
Can't access GitHub? Download the zip: [darwin-skill.zip](https://pub-161ae4b5ed0644c4a43b5c6412287e03.r2.dev/skills/darwin-skill.zip). Extract and place SKILL.md in `~/.opencode/skills/darwin-skill/`.
...
| 📺 Bilibili | [Upstream author](https://space.bilibili.com/14097567) |
| ▶️ YouTube | [@Alchain](https://www.youtube.com/@Alchain) |
| 📕 Xiaohongshu | [Upstream author](https://www.xiaohongshu.com/user/profile/5abc6f17e8ac2b109179dfdf) |
| 💬 WeChat | Search "Upstream author" |
...
MIT License © [Upstream author](https://github.com/alchaincyf)
