...
description: Create professional SVG logos from descriptions and design specs, with multiple concepts, layouts, and color variations. Use when users ask to create logos, brand identities, icons, or visual marks.
upstream: "https://github.com/rknall/claude-skills/tree/main/svg-logo-designer"
---
