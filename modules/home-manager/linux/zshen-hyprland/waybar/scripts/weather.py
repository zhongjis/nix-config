...
location_id = (
    "f7f80d4b066fca24e24a38b7137a4205cc339e06393e7888cf06d7a3ab304e48"
)
...
# status code
status_code = (
    html_data("#regionHeader").attr("class").split(" ")[2].split("-")[2]
)
# print(status_code)
...
try:
    ...
    print(f"Failed to write to the cache file: {e}")
